...
?>  
    ...
    <div class="container-fluid remove-vid-marg" style="backgorund:rgba(30, 38, 80, 0.7);">
      <div class="vid-parent">
        <!-- <video playsinline autoplay muted loop>
          <source src="video/banvid.mp4" />
        </video> -->
        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(30, 38, 80, 0.7);"></div>
        <img src="./image/pic1.jpg" style="width:100%;">
        <!-- <div class="vid-overlay"></div> -->
      </div>
      <div class="vid-content" >
        <h1 class="my-content">Welcome to ELP</h1>
    ...
    <div style="background-color:#3875c3;" class="container-fluid txt-banner" > <!-- Start Text Banner -->
    ...
    <div style="background-color:#3875c3;" class="container-fluid"> <!-- Start Social Follow -->
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>At ELMS, we believe in accessible, innovative learning experiences that adapt to your schedule and learning style.
                 Join us in embracing the future of education and unlock your potential with our immersive online courses.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>ELMS Pvt Ltd <br> Dehradun, Uttarakhand <br> Ph. 000000000 </p>
          </div>
        </div>
      </div>
